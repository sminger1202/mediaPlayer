...
public abstract class ImageAsyncTask<Params, Progress, Result> {
	...
	private static final int MAXIMUM_POOL_SIZE = 36;
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new ImageAsyncTaskResult<Result>(
									ImageAsyncTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new ImageAsyncTaskResult<Result>(ImageAsyncTask.this,
								result));
				message.sendToTarget();
			}
		};
	 ...
	 */
	public final ImageAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	...
	protected final void publishProgress(Progress... values) {
		sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
				new ImageAsyncTaskResult<Progress>(this, values))
				.sendToTarget();
	}
