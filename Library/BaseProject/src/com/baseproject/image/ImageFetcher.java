...
public class ImageFetcher extends ImageResizer {
	 ...
	 */
	private Bitmap processBitmap(String data, ImageView mImageView) {
		...
		if (f != null) {
			...
			try {
				if (mImageView != null && mImageView.getWidth() > 0 && mImageView.getHeight() > 0) {
					return decodeSampledBitmapFromFile(f.toString(), mImageView.getWidth(), mImageView.getHeight());
				} else {
				...
				System.gc();
//				Logger.e(Youku.TAG_GLOBAL, "ImageFetcher#processBitmap()", e);
			}
		}
	...
	protected Bitmap processBitmap(Object data, ImageView mImageView) {
		return processBitmap(String.valueOf(data), mImageView);
	}
