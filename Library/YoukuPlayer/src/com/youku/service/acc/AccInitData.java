...
public class AccInitData {
	...
	public static final String DOWNLOAD_SWITCH = "download_switch";
	...
	public static void setDownloadSwitch(Context context, Boolean downloadSwitch) {
		Editor editor = context.getSharedPreferences(PREFS_NAME, PREFS_MODE).edit();
		editor.putBoolean(DOWNLOAD_SWITCH, downloadSwitch);
		editor.commit();
	}
	
	public static void setPlaySwitch(Context context, Boolean playSwitch) {
		Editor editor = context.getSharedPreferences(PREFS_NAME, PREFS_MODE).edit();
		editor.putBoolean(PLAY_SWITCH, playSwitch);
		editor.commit();
	}
	...
	public static int getP2pSwitch(Context context) {
		...
		return savedata.getInt(P2P_SWITCH, 0);
	}
	 ...
	 * @return 默认关闭
	 */
	public static Boolean getDownloadSwitch(Context context) {
		SharedPreferences savedata = context.getSharedPreferences(PREFS_NAME, PREFS_MODE);
		Boolean flag = savedata.getBoolean(DOWNLOAD_SWITCH, true);
		Logger.d(TAG, "getDownloadSwitch : flag = " + flag);
	 ...
	 * @return 默认关闭
	 */
	public static Boolean getPlaySwitch(Context context) {
		SharedPreferences savedata = context.getSharedPreferences(PREFS_NAME, PREFS_MODE);
		Boolean flag = savedata.getBoolean(PLAY_SWITCH, true);
		Logger.d(TAG, "getDownloadSwitch : flag = " + flag);
		return flag;
	}
