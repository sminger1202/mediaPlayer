...
public abstract class YoukuAsyncTask<Params, Progress, Result> {
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			return new Thread(r, "YoukuAsyncTask #" + mCount.getAndIncrement());
		}
	};

	private static final ThreadPoolExecutor sExecutor = new ThreadPoolExecutor(
			CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS,
			sWorkQueue, sThreadFactory, new ThreadPoolExecutor.DiscardPolicy());
	...
	public enum Status {
		...
		RUNNING,
		/**
		 * Indicates that {@link YoukuAsyncTask#onPostExecute} has finished.
		 */
		FINISHED,
	}
...
//					android.util.Log.w(LOG_TAG, e);
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new YoukuAsyncTaskResult<Result>(
									YoukuAsyncTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new YoukuAsyncTaskResult<Result>(YoukuAsyncTask.this,
								result));
				message.sendToTarget();
			}
		};
	 ...
	 *            The parameters of the task.
	 * 
	 * @return This instance of YoukuAsyncTask.
	 * 
	 ...
	 */
	public final YoukuAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	...
	private static class YoukuAsyncTaskResult<Data> {
		...
		final YoukuAsyncTask mTask;
		final Data[] mData;

		@SuppressWarnings({ "rawtypes" })
		YoukuAsyncTaskResult(YoukuAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
